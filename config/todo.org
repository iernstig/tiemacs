...
--- Rules ---
1. install and start all packages in install-packages.el
2. start up packages in initialize-packages.el
3. specify specific rules in a file in module-configurations folder
4. 
